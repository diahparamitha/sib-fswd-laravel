        ...
        <div class="container-fluid" style="margin-bottom: 30px; padding-top: 3px;">
          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
              ...
              <tr>
                <th>{{$i}}</th>
                <td><img class="avatar" src="https://source.unsplash.com/100x100?{{ $data->name }}" alt="Avatar"></td>
                <td><?= $data["name"]; ?></td>
                ...
                <td>
                  ...
                  <a href="#" onclick="return confirm('Yakin data user {{$data->name}} mau diubah?')"><button class="btn btn-warning">edit</button></a> ||
